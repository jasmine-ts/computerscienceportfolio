...
public class AugmentedStreetMapGraph extends StreetMapGraph {
    ...
    public AugmentedStreetMapGraph(String dbPath) {
        ...
        for (Node n : nodes) {
            List<WeightedEdge<Long>> nNeighbors = this.neighbors(n.id());
            if (nNeighbors.size() != 0) { //check if n has neighbors
                double xVal = n.lon();
                double yVal = n.lat();
        ...
        WPS = new WeirdPointSet(listOfPoints);
    }
